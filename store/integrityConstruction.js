...
export const useIntegrity = defineStore("integrityConstruction", {
  state: () => {
    return {
      ...
      companyList: [
        {
          icon: "imgs/integrityConstruction/company01.png",
        ...
        {
          icon: "imgs/integrityConstruction/company02.png",
          title: "中亿丰控股集团有限公司",
        ...
        {
          icon: "imgs/integrityConstruction/company03.png",
        ...
        {
          icon: "imgs/integrityConstruction/company04.png",
          title: "苏州市江枫白蚁防治有限公司",
        ...
        {
          icon: "imgs/integrityConstruction/company05.png",
          title: "苏州固百年建设科技有限公司",
